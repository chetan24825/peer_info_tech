...
@section('content')
    ...
    <div class="row">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="{{ route('platform.store') }}" class="row g-3">
                            @csrf


                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <label for="input-label" class="form-label">Name:</label>
                                <input name="name" placeholder="Enter Platform Name" type="text" class="form-control"
                                    id="input" required>
                            </div>
        ...
        <div class="modal fade" id="EditModalData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('platform.update') }}" class="row g-3">
                            @csrf
                            @method('PATCH')
                            <input type="hidden" name="update_id" class="update_id">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <label for="input-label" class="form-label">Name:</label>
                                <input name="name" type="text" class="form-control edit_name" id="input" required>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <label for="status" class="form-label">Status:</label>
                                <select name="status" id="status" class="form-control edit_status" required>
            ...
            $(document).on('click', '.delete_btn', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        let url = "{{ route('platform.delete', ':id') }}";
                        url = url.replace(':id', _id);
                        $.ajax({
                            url: url,
                            type: 'DELETE',
