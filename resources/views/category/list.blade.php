            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="addModalLabel1">Add Category</h6>
        ...
        <div class="modal fade" id="EditModalData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('category.update') }}" class="row g-3">
                            @csrf
                            @method('PATCH')
        ...
        $(document).ready(function() {
          ...
          `,
            ...
            $(document).on('click', '.delete_btn', function(e) {
                ...
                let id = $(this).data('id');
                let url = "{{ route('category.delete', ':id') }}".replace(':id', id);
