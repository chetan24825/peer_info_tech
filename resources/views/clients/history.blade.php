                        ...
                        <form method="POST" action="{{ route('clients.update') }}" class="row g-3">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                ...
                                <input name="domain_name" placeholder="Enter Domain Name" type="text"
                                    class="form-control" id="input-date" required>
                            </div>
                    ...
                    <div class="row w-100 mr-0 d-flex">
                            ...
                            <div class="report_reference_filter_wrapper" style="margin-top:3px;margin-left:10px;">
                                <div class="">
                                    <div class="filter_dropdown">
                                        ...
                                        <select name="category" id="category" class="form-control focus_class category">
                                ...
                                <div class="">
                                    <div class="filter_dropdown">
                                        ...
                                        <select name="service_type" id="service_type"
                                            class="form-control focus_class service_type">
                                            {{-- <option @if (request()->service_type == 'all') selected @endif value="">All</option> --}}
                                            <option value="{{ false }}">All</option>
                                            @foreach ($data['service_types'] as $item)
                                                <option value="{{ $item->slug }}">
                        ...
                        <div class="col-6 col-sm-2 col-md-2 col-lg-2 col-xl-2 p-0 column">
                            <div class="report_reference_filter_wrapper" style="margin-top:3px;margin-left:10px;">
                                <div class="">
                                    <div class="filter_dropdown">
                                        <label class="from_date_label" for="from_date"
                                            style="margin-right:10px;">From:</label>
                                        <input type="date" value="{{ request()->start_date }}" name="start_date"
                                            id="start_date" class="form-control focus_class start_date" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-6 col-sm-2 col-md-2 col-lg-2 col-xl-2">
                            <div class="report_reference_filter_wrapper" style="margin-top:3px;margin-left:10px;">
                                <div class="">
                                    <div class="filter_dropdown">
                                        <label class="from_date_label" for="from_date"
                                            style="margin-right:10px;">To:</label>
                                        <input value="{{ request()->end_date }}" type="date" name="end_date"
                                            id="end_date" class="form-control focus_class end_date" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="margin-left:-27px; margin-top:11px;"
                            ...
                            <div class="report_filter_btns d-flex justify-content-start align-items-end"
                                ...
                                <button type="button" class="btn btn-success btn-sm filter_clients_records"
                                    id="filter_clients_records" style="margin-left:5px;"><i
                                        class="fa fa-search"></i><small style="font-weight:900">Filter</small>
                                </button>

                                <button type="button" class="btn btn-danger btn-sm" id="reset_btn"
                                    style="margin-left:5px;"><i class="ik ik-refresh-ccw"></i><small
                                        style="font-weight:900">Reset</small>
                                </button>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            function load_datatable(category = "", platform = "", website_type = "", service_type = "", start_date =
                "", end_date = "") {
