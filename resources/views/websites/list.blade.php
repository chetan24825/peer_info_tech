      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <form method="POST" action="{{ route('website.store') }}" class="row g-3">
              @csrf
    ...
    <div class="modal fade" id="EditModalData" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" action="{{ route('website.update') }}" class="row g-3">
              @csrf
              @method('PATCH')
      ...
      $(document).on('click', '.delete_btn', function(e) {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
             ...
             let url = "{{ route('website.delete', ':id') }}";
             url = url.replace(':id', _id);
             $.ajax({
              url: url,
              type: 'DELETE',
